...
class Category extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $data['pagination'] = $this->category->makePagination(base_url('category'), $data['start'], $data['total_rows']);
    ...
    public function search($page = null)
    {
        ...
        $data['pagination'] = $this->category->makePagination(base_url('category/search'), $data['start'], $data['total_rows']);
        $data['page']       = 'pages/category/index';
